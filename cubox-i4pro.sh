#!/usr/bin/env bash
#
# Threat Linux ARM build-script for CuBox-i4Pro (32-bit) - Freescale based NOT the original Marvell based
# Source: https://github.com/threatcode/build-scripts/threat-arm
#
# This is a community script - you will need to generate your own image to use
# More information: https://www.threatcode.github.io/docs/arm/cubox-i4pro/
#
