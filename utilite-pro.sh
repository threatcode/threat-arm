#!/usr/bin/env bash
#
# Threat Linux ARM build-script for Utilite Pro (32-bit)
# Source: https://github.com/threatcode/build-scripts/threat-arm
#
# This is a community script - you will need to generate your own image to use
# More information: https://www.threatcode.github.io/docs/arm/utilite-pro/
#
...
image_name=${3:-threat-linux-$1-utilite-pro}
...
# Mirror replacement
if [[ ! -z "${@:5}" || "$suite" != "threat-rolling" ]]; then
    mirror=${@:5}
    [ ! -z "${@:5}" ] || mirror="http://threatcode.github.io/threat"
    [ "$suite" != "threat-rolling" ] && suite=threat-rolling
...
# Clone a cross compiler to use instead of the Threat one due to kernel age
