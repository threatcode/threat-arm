...
def write_file(data, file):
    try:
        with open(file, "w") as f:
            meta = "---\n"
            meta += "title: Threat ARM Device Statistics\n"
            meta += "---\n\n"

            stats = f"- The official [Threat ARM repository](https://github.com/threatcode/build-scripts/threat-arm) contains [build-scripts]((https://github.com/threatcode/build-scripts/threat-arm)) to support [**{qty_devices}** Threat ARM devices](devices.html)\n"
