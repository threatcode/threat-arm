#!/usr/bin/env bash
#
# Threat Linux ARM build-script for ODROID-U2/U3 (32-bit)
# Source: https://github.com/threatcode/build-scripts/threat-arm
#
# This is a community script - you will need to generate your own image to use
# More information: https://www.threatcode.github.io/docs/arm/odroid-u/
#
...
image_name=${3:-threat-linux-$1-odroid-u}
...
tools="threat-tools-top10 wireshark"
