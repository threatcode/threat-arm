#!/usr/bin/env bash
#
# Threat Linux ARM build-script for Chromebook 1/2 (Exynos Samsung daisy_snow/peach_pi/peach_pit & HP daisy_spring) (32-bit)
# Source: https://github.com/threatcode/build-scripts/threat-arm
#
# This is a community script - you will need to generate your own image to use
# More information: https://www.threatcode.github.io/docs/arm/chromebook-exynos/
#
...
image_name=${3:-threat-linux-$1-chromebook-exynos}
