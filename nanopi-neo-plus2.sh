#!/usr/bin/env bash
#
# Threat Linux ARM build-script for NanoPi NEO Plus2 (64-bit)
...
# More information: https://www.threatcode.github.io/docs/arm/nanopi-neo-plus2/
#
...
eatmydata apt-get install -y threat-sbc-allwinner linux-image-arm64 firmware-brcm80211
