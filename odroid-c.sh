#!/usr/bin/env bash
#
# Threat Linux ARM build-script for ODROID-C0/C1/C1+ (32-bit)
# Source: https://github.com/threatcode/build-scripts/threat-arm
#
# This is a community script - you will need to generate your own image to use
# More information: https://www.threatcode.github.io/docs/arm/odroid-c/
#
...
image_name=${3:-threat-linux-$1-odroid-c}
...
extras="alsa-utils bc bison bluez bluez-firmware fbset threat-linux-core \
