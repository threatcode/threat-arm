#!/usr/bin/env bash
#
# Threat Linux ARM build-script for Pinebook (64-bit)
...
# More information: https://www.threatcode.github.io/docs/arm/pinebook/
#
...
eatmydata apt-get install -y dkms threat-sbc-allwinner linux-headers-arm64 linux-image-arm64
