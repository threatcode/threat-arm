#!/usr/bin/env bash
#
# Threat Linux ARM build-script for ODROID-C2 (64-bit)
...
# More information: https://www.threatcode.github.io/docs/arm/odroid-c2/
#
...
eatmydata apt-get install -y dkms threat-sbc-amlogic linux-image-arm64
